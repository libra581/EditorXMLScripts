...
myBlockTask::myBlockTask(QRect rect, QString str, const QColor & color, QWidget *parent)
    : QWidget(parent)
{
    this->text  = str;
    this->color = color;
...
void myBlockTask::paintEvent(QPaintEvent *event)
{
    QPainter painter;
    painter.begin( this );
    ...
    painter.drawLine( QPoint(12,3), QPoint(12,height()-19));
    painter.drawLine( QPoint(width()-12,3), QPoint(width()-12,height()-19));
